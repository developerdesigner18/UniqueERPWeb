...
export default function Invite({
  ...
  async function sendInvite() {
    await fetch("https://www.contingentpro.com/invite", {
      ...
      .then((x) => {
        if (x.status) {
          alert("Invite was sent to the Candidate");
        } else {
          alert(x.message);
        }
        clear();
      ...
      >
        <MDBCardBody className="p-5 w-100 d-flex flex-column">
          ...
          <MDBInput
            ...
            value={emailID}
            onChange={(e) => changeInput(e, "emailID")}
          />
          <MDBInput
            type="text"
            id="yourAlias"
            ...
            wrapperClass="mb-4 w-100"
            value={yourName}
            onChange={(e) => changeInput(e, "yourName")}
          />

          <MDBRow className="mb-3 d-flex align-items-center">
            <MDBCol className="d-flex align-items-center justify-content-center">
              <MDBBtn type="submit" color="secondary" onClick={cleartoggle}>
                Clear
              </MDBBtn>
            </MDBCol>
            <MDBCol className="d-flex align-items-center justify-content-center">
              <MDBBtn type="submit" color="secondary" onClick={() => cancel()}>
                Cancel
              </MDBBtn>
            </MDBCol>

            <MDBCol className="d-flex align-items-center justify-content-center">
              <MDBBtn type="submit" onClick={() => sendInvite()}>
                Invite
              </MDBBtn>
            </MDBCol>
          </MDBRow>
