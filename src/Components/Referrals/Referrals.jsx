  ...
  return (
    <div>
      ...
      <Row style={{ width: "70%", margin: "0 auto" }}>
        ...
        <Col md={6}>
          <Row style={{ width: "70%", margin: "0 auto", border: "20px dark" }}>
            <h5>Referral Bonus Details </h5>
          </Row>
          <Row>
            <Col md={6}>Number of Consultants Referred</Col>
            <Col>:{bonusDetails.length > 0 && bonusDetails[0].creditValue}</Col>
          </Row>
          <Row>
            <Col md={6}>Referral Credits</Col>
            <Col>:{bonusDetails.length > 0 && bonusDetails[2].creditValue}</Col>
          </Row>
          <Row>
            <Col md={6}>Interview Credits</Col>
            <Col>
              {" "}
          ...
          <Row>
            <Col md={6}>Credits Paid</Col>
            <Col>:{bonusDetails.length > 0 && bonusDetails[1].creditValue}</Col>
          </Row>
        </Col>
      </Row>
    </div>
